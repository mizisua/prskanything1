import os, json, tweepy, time, datetime, random, requests, re, sys
    ...
    consumer_key = os.environ['U7XEPUo0ADYTMYiTi6nRDAd3o']
    consumer_secret = os.environ['ekUSJDku9RGGqY1GtnEsUCs3JM4LC5DO12OQpJU9JsoJUcvG9p']
    access_token = os.environ['1371928178315259905-53w7FVkRwMxVusY4pZwh8pMGsmlEYC']
    access_token_secret = os.environ['rbymXEYL2SEGQ5dscOktA8y82wH4abY8tJ0QA4B0K7Mg0']
